...
public final class Constant {
    ...
    public static String errMsg_2 = "人证核验查询异常";
    ...
    public static String errMsg21 = "暂无运单轨迹";
    ...
    public static int errCode25 = 500;
    public static String errMsg25 = "系统升级中，转邮寄业务暂停办理，由此带来的不便敬请谅解！";
